...
struct SamplerContext {
    ...
    // Temperature decimation state
    // Skip temperature read 9 out of 10 times (1kHz -> 100Hz)
    // to save I2C transaction overhead.
