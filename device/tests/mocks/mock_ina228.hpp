...
public:
    ...
    bool read_vbus_raw(uint32_t& raw) const { raw = 0; return true; }
    bool read_vshunt_raw(int32_t& raw) const { raw = 0; return true; }
    bool read_current_raw(int32_t& raw) const { raw = 0; return true; }
    bool read_temp_raw(int16_t& raw) const { raw = 0; return true; }
